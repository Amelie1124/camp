...
(lib.player3_mc = function(mode,startPosition,loop,reversed) {
...
}).prototype = getMCSymbolPrototype(lib.player3_mc, new cjs.Rectangle(0,0,80,86), null);


(lib.player2_mc = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.player2_mc, new cjs.Rectangle(0,0,80,86), null);


(lib.player1_mc = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.player1_mc, new cjs.Rectangle(0,0,80,86), null);


(lib.player0_mc = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.player0_mc, new cjs.Rectangle(0,0,80,86), null);
...
if (reversed == null) { reversed = false; }
	...
	// 圖層_1
	this.instance = new lib.player0_mc();
	this.instance.setTransform(40,43,1,1,0,0,0,40,43);

	this.instance_1 = new lib.player1_mc();
	this.instance_1.setTransform(40,43,1,1,0,0,0,40,43);

	this.instance_2 = new lib.player3_mc();
	this.instance_2.setTransform(40,43,1,1,0,0,0,40,43);

	this.instance_3 = new lib.player2_mc();
	this.instance_3.setTransform(40,43,1,1,0,0,0,40,43);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},6).wait(7));
...
if (reversed == null) { reversed = false; }
	...
	this.gameover_text.lineWidth = 545;
	this.gameover_text.parent = this;
	this.gameover_text.setTransform(653.5,81.3);
	...
	this.score_text.lineWidth = 238;
	this.score_text.parent = this;
	this.score_text.setTransform(1130.95,26.05);
...
p.nominalBounds = new cjs.Rectangle(640,384.1,1760,89.89999999999998);
// library properties:
lib.properties = {
	id: 'BC6C290DA8B1B1408F7BB11FEB1A958C',
	width: 1280,
	height: 720,
	fps: 60,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/dino_atlas_1.png?1657603769768", id:"dino_atlas_1"}
	],
	preloads: []
};
...
an.compositions['BC6C290DA8B1B1408F7BB11FEB1A958C'] = {
